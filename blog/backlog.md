...
- [x] **便宜 2 美元的炉子为什么让你亏钱：保修成本总账**（已上线：pain-warranty-math）
...
- [x] **集装箱雨：海运霉变毁掉整柜炉子**（slug 建议：pain-container-rain）——⛔ 雪姐 2026-09-05 判定不要，取消
...
- [x] **贴牌错印/混批：logo 印错、型号混装、标签错译怎么防**（已上线：pain-private-label-mixup）（ZCode 自拟，2026-09-17；OEM 品牌商最痛的整柜拒收风险，之前未覆盖）
- [x] **工厂倒闭/跑路致断供、模具丢失、旺季无货**（已上线：pain-supplier-shutdown）（ZCode 自拟，2026-09-18；供应连续性风险，之前未覆盖；非认证非说明书）
